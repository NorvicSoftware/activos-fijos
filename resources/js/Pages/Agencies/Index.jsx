...
export default function Index ({ auth }){
    ...
    return (
        <AuthenticatesLayout    user={auth.user}    header={<h2 className="font-semibold text-xl text-gray-800 dark:text-black-200 leading-tight">Agencias</h2>}>
            <Head title="Agencias" />
                                ...
                                <tbody>
                                    {agencies.map(agency => (
                                        <tr key={agency.id}>
                                            ...
                                            <td>
                                                <a className="EditButton text-blue-500 dark:text-black-100" href={route('agencies.edit', agency.id)}>Editar</a>
                                            </td>
                                        </tr>
                                    ))
